        ...
        if rising_edge(clk) then
            ...
            if (reset = '1') then   -- Synchronous reset
                ...
                if ((cnt_i and cnt_i2 and cnt_i3 and cnt_i4) = '1') then
                    ...
                    if (s_cnt_local(0) = '0') and (s_cnt_local(1) = '1' ) and (s_cnt_local(2) = '0' ) and (s_cnt_local(3) = '0' ) then
                        s_cnt_local <= s_cnt_local + 1;
                        cnt_o <= '1';
                    elsif (s_cnt_local(0) = '1') and (s_cnt_local(1) = '1' ) and (s_cnt_local(2) = '0' ) and (s_cnt_local(3) = '0' ) then
                        s_cnt_local <= (others => '0'); -- Clear all bits
                        cnt_o <= '0';
                    else
                        s_cnt_local <= s_cnt_local + 1;
